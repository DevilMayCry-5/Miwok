...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView numberCategory = (TextView) findViewById(R.id.numbers);
        TextView familyCategory = (TextView) findViewById(R.id.family);
        TextView colorsCategory = (TextView) findViewById(R.id.colors);
        TextView phrasesCategory = (TextView) findViewById(R.id.phrases);

        /**
        TextView[] menu = {numberCategory, familyCategory, colorsCategory, phrasesCategory};
        ...
        /**
         * listens for click and starts the corresponding activity
         */
